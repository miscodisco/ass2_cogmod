...
```{r}
prior_mean_bias <- seq(0, 1, 0.1)
prior_sd_bias <- seq(0.1, 1, 0.1)
prior_mean_follow_bias <- seq(-2, 2, 0.25)
...
```{r}
#Priors
prior_mean_bias <- seq(0.1, 1, 0.15)
prior_sd_bias <- seq(0.1, 1, .3)
prior_mean_beta <- seq(0.1, 1, 0.15)
prior_sd_beta <- seq(0.1, 1.1, .3)
prior_mean_conf <- seq(-2, 2, 0.5)
prior_sd_conf <- seq(0.1, 1, .3)
...
recovery_df1 <- future_pmap_dfr(priors, sim_d_and_fit, .options = furrr_options(seed = TRUE))
